...
export default function Hero({ scrollY }: { scrollY: number }) {
    return (
      <section className="relative min-h-screen flex items-center px-5 sm:px-8 lg:px-12 pb-16 pt-28 lg:pt-10">

        {/* Two-column content grid */}
        <div className="relative z-10 max-w-[1240px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="text-center lg:text-left">
            ...
            <p className="anim-fade-up text-slate-500 leading-[1.8] max-w-[490px] mx-auto lg:mx-0 mb-9"
            ...
            {/* CTAs */}
            <div className="anim-fade-up flex flex-wrap justify-center lg:justify-start gap-3 mb-11" style={{ animationDelay: '0.24s' }}>
          ...
          <div className="anim-fade-in relative w-full max-w-[460px] mx-auto lg:max-w-none" style={{ animationDelay: '0.2s', transform: `translateY(${scrollY * -0.07}px)` }}>
            <MapViz />
          </div>
        </div>
      </section>
